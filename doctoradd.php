...
if( mysqli_num_rows($result) > 0 ) {
 ...
 if( isset( $_POST["submit"] ) ) {
    ...
    //set all variables to empty by default
     $patientname = $id = $diagnosis = $doctorname = $date_added = $medication ="";
    
    
   
    $patientname = validateFormData( $_POST["patientname"] );
    $id = validateFormData( $_POST["id"] );
    $doctorname = validateFormData( $_POST["doctorname"] );
    $diagnosis = validateFormData( $_POST["diagnosis"] );
    $date_added = validateFormData( $_POST["date_added"] );
    $medication = validateFormData( $_POST["medication"] );
   
    
    // check to see if each variable has data
    if( $patientname && $id && $doctorname && $diagnosis && $date_added && $medication) {
        $query = "INSERT INTO prescription (patientname, id, doctorname, diagnosis, date_added, medication)
               VALUES ('$patientname', '$id', '$doctorname', '$diagnosis', '$date_added', '$medication')";
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="doctor.php">Profile</a></li>
            <li><a href="prescription.php">Patient</a></li>
                ...
                <div class="box-content padded">
                             ...
                             <form class="form-signin" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>?id=<?php echo $id;?>"  method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="formDoctor">Doctor's Name</label>
                                
                                    <input type="text" id="formDoctor" name="doctorname" class="form-control"/>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="formDiag">Diagnosis</label>

                                        <textarea class="form-control" id="formDiag" name="diagnosis"></textarea>
                                </div>
                                 
                                <div class="form-group">

                                    <label for="formMed">Medication</label>

                                        <textarea class="form-control" id="formMed" name="medication"></textarea>
                                </div>
