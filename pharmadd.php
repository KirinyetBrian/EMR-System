...
$query = "SELECT * FROM prescription WHERE id ='$clientId'";
...
if( mysqli_num_rows($result) > 0 ) {
 ...
 if( isset( $_POST['submit'] ) ) {
    ...
    $medicinename = validateFormData( $_POST["medicinename"] );
                ...
                <div class="box-content padded">
                             ...
                             <form class="form-signin" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>?id=<?php echo $id;?>"  method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="formPrice">Medicine Price</label>

                                        <input type="text" id="formPrice" name="price" class="form-control" />
                                </div>
                                 
                                <div class="form-group">

                                    <label for="formMed">Medicine Name</label>

                                        <textarea class="form-control" id="formMed" name="medicinename"></textarea>
                                </div>
